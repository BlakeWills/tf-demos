...
resource "azurerm_firewall_policy_rule_collection_group" "hub-uks-firewall-rc" {
  ...
  network_rule_collection {
    ...
    rule {
      name                  = "spoke-one-spoke-three"
      protocols             = ["Any"]
      source_addresses      = [local.address_space.spoke_one_uks.vnet, local.address_space.spoke_three_uks.vnet]
      destination_addresses = [local.address_space.spoke_one_uks.vnet, local.address_space.spoke_three_uks.vnet]
      destination_ports     = ["*"]
    }

    rule {
      name                  = "spoke-two-spoke-three"
      protocols             = ["Any"]
      source_addresses      = [local.address_space.spoke_two_uks.vnet, local.address_space.spoke_three_uks.vnet]
      destination_addresses = [local.address_space.spoke_two_uks.vnet, local.address_space.spoke_three_uks.vnet]
      destination_ports     = ["*"]
    }
    ...
    rule {
      ...
      protocols             = ["Any"]
      source_addresses      = [local.address_space.spoke_one_uks.vnet, local.address_space.spoke_two_uks.vnet, local.address_space.spoke_three_uks.vnet]
